...
@section('content')
    ...
    <div class="flex flex-col gap-4 lg:p-4 p-2  rounde-lg m-2">
        ...
        @foreach($organizations as $organization)
            <a href="{{ route('admin.organization.profile', $organization->name) }}" class="flex items-center justify-between w-full p-2 lg:rounded-full md:rounded-full hover:bg-gray-200 transition duration-500 cursor-pointer border-2 rounded-lg">

                <div class="lg:flex md:flex items-center">
                    <div class="h-12 w-12 mb-2 lg:mb-0 border md:mb-0 rounded-full mr-3"> <img src="{{asset('/storage/images/' . $organization->image)}}" alt=""> </div>
